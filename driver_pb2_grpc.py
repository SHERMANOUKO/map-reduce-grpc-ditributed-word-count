...
class DriverStub(object):
    ...
    def __init__(self, channel):
        ...
        self.startDriver = channel.unary_unary(
                '/driverPackage.Driver/startDriver',
                request_serializer=driver__pb2.processData.SerializeToString,
...
def add_DriverServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'startDriver': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=driver__pb2.processData.FromString,
...
class Driver(object):
    ...
    def startDriver(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/driverPackage.Driver/startDriver',
            driver__pb2.processData.SerializeToString,
